...
<script src="<?= site_url('assets/templates/modernize/libs/datatables.net/js/jquery.dataTables.min.js') ?>"></script>
<script src='https://api.mapbox.com/mapbox-gl-js/v3.4.0/mapbox-gl.js'></script>
<script src="<?= site_url('assets/js/amagiloader.js') ?>"></script>
<script src="<?= site_url('assets/js/overall.js') ?>"></script>
<script src="<?= site_url('assets/modules/dashboard/overall.js') ?>"></script>
<!-- end js include path -->
